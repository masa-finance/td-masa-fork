...
* [Generated Go Documentation](https://ref.gotd.dev/pkg/github.com/masa-finance/td-masa-fork/tg.html)

Before using this library, read [How To Not Get Banned](.github/SUPPORT.md#how-to-not-get-banned) guide.

Due to limitations of `pkg.go.dev`, documentation for `tg` package is not shown, but there is [hosted version](https://ref.gotd.dev/pkg/github.com/masa-finance/td-masa-fork/tg.html).
...
```console
go get github.com/masa-finance/td-masa-fork
```
...
import (
	...
	"github.com/masa-finance/td-masa-fork/telegram"
)
...
* Full MTProto 2.0 implementation in Golang, directly access any MTProto method with [telegram.Client.API()](https://pkg.go.dev/github.com/masa-finance/td-masa-fork@v0.60.0/telegram#Client.API)
...
* [Conforms](https://github.com/masa-finance/td-masa-fork/issues/155) to [Security guidelines](https://core.telegram.org/mtproto/security_guidelines) for Telegram client software developers
  * Secure PRNG used for crypto
  * Replay attack protection
* 2FA support
* MTProxy support
* Various helpers that lighten the complexity of the Telegram API
  * [uploads](https://pkg.go.dev/github.com/masa-finance/td-masa-fork/telegram/uploader) for big and small files with multiple streams for single file and progress reporting
  * [downloads](https://pkg.go.dev/github.com/masa-finance/td-masa-fork/telegram/downloader) with CDN support, also multiple streams
  * [messages](https://pkg.go.dev/github.com/masa-finance/td-masa-fork/telegram/message) with various convenience builders and text styling support
  * [query](https://pkg.go.dev/github.com/masa-finance/td-masa-fork/telegram/query) with pagination helpers
  * [middleware](https://pkg.go.dev/github.com/masa-finance/td-masa-fork/telegram#Middleware) for [rate limiting](https://pkg.go.dev/github.com/gotd/contrib/middleware/ratelimit) and [FLOOD_WAIT handling](https://pkg.go.dev/github.com/gotd/contrib/middleware/floodwait)
* Connection pooling
...
Current implementation [mostly conforms](https://github.com/masa-finance/td-masa-fork/issues/155) to security guidelines, but no
...
Drop a comment [here](https://github.com/masa-finance/td-masa-fork/issues/568) to add your project.
...
- [Examples](https://github.com/masa-finance/td-masa-fork/blob/-/examples/README.md)
- [Security policy](https://github.com/masa-finance/td-masa-fork/blob/-/.github/SECURITY.md)
- [User support and dev chat](https://github.com/masa-finance/td-masa-fork/blob/-/.github/SUPPORT.md)
- [Roadmap](https://github.com/masa-finance/td-masa-fork/blob/-/ROADMAP.md)
- [Contributing](https://github.com/masa-finance/td-masa-fork/blob/-/CONTRIBUTING.md)
- [Architecture](https://github.com/masa-finance/td-masa-fork/blob/-/ARCHITECTURE.md)
- [Generated Go Documentation](https://ref.gotd.dev/pkg/github.com/masa-finance/td-masa-fork/tg.html)
